"use strict"
	...
	function renderQuestion(){
		...
		if(pos >= questions.length){
			...
			var emptyFields = $("<h4></h4>").text("Моля попълнете всички полета.").addClass("invisible")
		...
		switch (questions[pos][questions[pos].length-1]){
			...
			break;
			case("checkbox"):
				var subTitle = $("<h4></h4>").text("Въпрос с множество избираеми отговори (изберете поне един). След като сте направили Вашия избор, моля натиснете напред.");
